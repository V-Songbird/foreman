...
// Reviewed increments are a Codex feature, so every handoff here is assembled
// for host codex.
...
function request(destination = 'task') {
  return { entry: '001', host: 'codex', destination, split: true, resume: true, reviewEachIncrement: true,
